...
DUMP_PATH       = "enwiki-latest-pages-articles.xml.bz2"   # path to your downloaded dump
CATEGORIES_FILE = "../categories.txt"                        # your subject's category list
OUTPUT_FILE     = "subwiki.jsonl"                             # name this whatever fits your project
    ...
    with open(OUTPUT_FILE, "w", encoding="utf-8") as out:
        for page in stream_pages(DUMP_PATH):
            ...
            record = {
                ...
                "all_page_categories": all_cats,   # full category list, not just the matched subset —
                                                     # Stage 2 uses this for richer category scoring
            }
