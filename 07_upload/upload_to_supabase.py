#!/usr/bin/env python3
"""
upload_to_supabase.py — Stage 7: upload the merged keyword set to Supabase
and write keywords.json for the Next.js popup component.

Pipeline:
    keywords_combined.jsonl → keywords.json  (popup component)
...
Usage:
    ...
    python upload_to_supabase.py ^
        --input ../06_merge/keywords_combined.jsonl ^
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        "--input",
        default="../06_merge/keywords_combined.jsonl",
        help="Path to merged JSONL file (default: ../06_merge/keywords_combined.jsonl)",
    )
    p.add_argument(
        "--output",
